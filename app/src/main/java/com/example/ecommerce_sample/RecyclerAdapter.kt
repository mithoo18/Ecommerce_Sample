...
import com.example.ecommerce_sample.MainActivity.Companion.RecyclerView2


class RecyclerAdapter(listdata: Array<ListData>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            RecyclerView2(holder.textView.text.toString())
            Log.d("Checking ","1 Value"+position+"2 Value" +holder.textView.text.toString())
        }
    }
